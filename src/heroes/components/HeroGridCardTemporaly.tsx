...
type EditorialType = 'DC' | 'MARVEL'
type OrganizationType = 'Justice League' | 'Avengers'
type HeroOrAntiHero = 'Hero' | 'Anti-Hero'
...
interface Props {
    ...
    heroOrAntiHero: HeroOrAntiHero;
    description: string;
}

const HeroGridCardTemporaly = ({statusA_I, hero, name, organization, editorial, heroOrAntiHero, description}: Props) => {
  return (
    <Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-linear-to-br from-white to-gray-50">
                    <div className="relative h-64 overflow-hidden">
                        ...
                        {/* Universe badge */}
                        <Badge className="absolute top-3 right-3 text-xs bg-blue-600 text-white">{editorial}</Badge>
                    ...
                    <CardHeader className="pb-3">
                        <div className="flex justify-between items-start">
                            ...
                            <Badge className="text-xs bg-green-100 text-green-800 border-green-200">{heroOrAntiHero}</Badge>
                        </div>
...
export default HeroGridCardTemporaly
