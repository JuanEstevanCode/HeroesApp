        ...
        <Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-linear-to-br from-white to-gray-50">
            <div className="relative h-64">
                <img
                    src={hero.image}
                    alt={hero.name}
                    className="object-cover transition-all duration-500 group-hover:scale-110 absolute -top-7.5 w-full h-95"
                    onClick={handleClick}
                />
                ...
                >
                    <Heart className={`h-4 w-4 ${isFavorite(hero) ?  "fill-red-500" :  "fill-gray-500"}`} />
                </Button>
